...
<body>
	<div class="table-responsive container">
		<div class="center-block" style="width: 100%; padding: 5px">
			<p class="text-center bg-danger" style="padding: 5px"><b>读者类型</b></p>
...
<script type="text/javascript">
	$('#table_table')
			.bootstrapTable(
					{
						url : '${pageContext.request.contextPath}/findTypeReader', // 表格数据来源
						//method : 'post',
