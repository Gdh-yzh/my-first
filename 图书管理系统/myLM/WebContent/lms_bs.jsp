	...
	<div class="container-fluid">
			...
			<div class="col-md-12">
				<div style="width: 100%;">
					...
					<div id="div_userInfo" class="hidden-xs"
						...
						您好,${user.username}<br> <span class="glyphicon glyphicon-time"
		...
		<div class="row" id="div_centerRow">
			...
			<div id="div_left" class="col-md-2">
				...
				<div class="panel panel-default" id="one">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion"
								...
								class="glyphicon glyphicon-book" aria-hidden="true"></span>图书管理<span
					...
					<div id="collapseOne" class="panel-collapse collapse in">
						<div class="panel-body">
							<ul>
								<li id="addBook"><a href="#"><span
										class="glyphicon glyphicon-align-left" aria-hidden="true"></span>添加图书</a></li>
								<li id="bookManagement"><a href="#"><span
										class="glyphicon glyphicon-align-left" aria-hidden="true"></span>图书管理</a></li>
					...
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion"
								...
								class="glyphicon glyphicon-retweet" aria-hidden="true"></span>借阅管理<span
								id="be_rightIcon" class="glyphicon glyphicon-menu-down"
								aria-hidden="true"></span></a>
						</h4>
					</div>
					<div id="collapseFive" class="panel-collapse collapse">
						<div class="panel-body">
							<ul>
								...
								<li id="borrowManagement"><a href="#"><span
										class="glyphicon glyphicon-align-left" aria-hidden="true"></span>借阅管理</a></li>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion"
								...
								aria-hidden="true"></span>读者管理 <span id="be_rightIcon"
					...
					<div id="collapseThree" class="panel-collapse collapse">
						<div class="panel-body">
							<ul>
								<li id="addReader"><a href="#"><span
										class="glyphicon glyphicon-align-left" aria-hidden="true"></span>添加读者</a></li>
								<li id="readerManagement"><a href="#"><span
										class="glyphicon glyphicon-align-left" aria-hidden="true"></span>读者管理</a></li>
								<li id="queryReader"><a href="#"><span
										class="glyphicon glyphicon-align-left" aria-hidden="true"></span>读者查询</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion"
								...
								class="glyphicon glyphicon-signal" aria-hidden="true"></span>数据盘点<span
								id="be_rightIcon" class="glyphicon glyphicon-menu-down"
								aria-hidden="true"></span> </a>
						</h4>
					</div>
					<div id="collapseFour" class="panel-collapse collapse">
						<div class="panel-body">
							<ul>
								<li id="borrowCount"><a href="#"><span
										class="glyphicon glyphicon-align-left" aria-hidden="true"></span>借阅统计</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div id="div_right" class="col-md-1" style="border: none;">
				...
				<p style="width: 100px;padding-left: 15px;">本系统为图书管理员提供更为简单便捷的线上图书馆服务。</p>
			</div>
		</div>
...
<script type="text/javascript">
	...
	$("#exit_ok").click(function(){
		window.location.href = "${pageContext.request.contextPath}/"+"login_user.jsp";
	});
	$(function() {
		//默认加载
	...
	function path(){
		...
		$("#readerManagement").click(function() {
			changeLoad("#readerManagement", "readerManagement.jsp");
		});
